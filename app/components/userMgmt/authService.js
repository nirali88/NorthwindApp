define("authService", ['app'], function (app) {
    "use strict";

    app.register.service('authService', ['$http', 'config', 'userService',
        '$rootScope', '$window', authService]);

    function authService($http, config, userService, $rootScope, $window) {
        this.Login = Login;
        ...
        function SetCredentials(userName, password) {
            ...
            //store logged in user to sessionStorage
